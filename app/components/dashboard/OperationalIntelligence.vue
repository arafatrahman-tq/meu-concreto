    ...
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-8">
        ...
        <div class="flex flex-col">
          ...
          <span class="text-[11px] font-black uppercase text-white mt-1">Status de Operação</span>
        </div>
      </div>
      <h3
      ...
      >
        <div class="flex justify-between items-end mb-2">
          ...
          <span class="text-xs font-black text-white tabular-nums">{{ stats.fiscal?.percentual || 0 }}%</span>
        </div>
        <div
