  ...
  <div class="relative group" ref="containerRef">
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <!-- Loading State -->
          <div v-if="loading" class="px-5 py-4 flex items-center gap-3 text-secondary/40 text-[10px] font-black uppercase tracking-widest">
            <RefreshCw size="14" class="animate-spin text-brand" />
            Buscando resultados...
          </div>
