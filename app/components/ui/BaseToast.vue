<template>
  <Teleport to="body">
    <div
      class="fixed top-8 right-8 flex flex-col gap-3 pointer-events-none"
      style="z-index: 150;"
    >
      <TransitionGroup
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <AlertTriangle
              v-else-if="toast.type === 'error' || toast.type === 'warn'"
              size="20"
            />
            <Info
              v-else
          ...
          <div class="flex-1">
            <p class="text-[11px] font-bold uppercase tracking-[0.15em] opacity-60 mb-0.5">
              {{ toast.type
                || 'INFO' }}
            </p>
          ...
          <button
            class="opacity-40 hover:opacity-100 transition-opacity p-2 -mr-2"
