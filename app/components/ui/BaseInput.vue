<template>
  <div class="relative group">
    ...
    <input
      ...
      @input="onInput"
      v-bind="$attrs"
      class="w-full bg-primary/2 border border-border rounded-2xl py-3.5 text-sm font-bold text-primary placeholder:text-secondary/30 focus:ring-2 focus:ring-brand/20 focus:border-brand/30 transition-all font-sans outline-none tracking-tight"
