  ...
  <div class="flex flex-col gap-6 animate-enter">
    ...
    >
      ...
      <div class="xl:col-span-8 space-y-8">
        ...
        <div class="space-y-4">
          ...
          >
            <div class="space-y-2">
              ...
              />
              <p
                class="text-[8px] font-medium text-secondary opacity-40 ml-2 italic"
              >
                A chave é armazenada de forma criptografada no servidor.
              </p>
            </div>
              ...
              >
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    >
                      Ativar Gateway Asaas para pagamentos
                    </p>
                  </div>
                </div>
                <BaseToggle
        ...
        <!-- Instruções -->
        <div
          class="bg-brand/5 rounded-[2rem] p-8 border border-brand/10 flex gap-6 items-start group hover:bg-brand/10 transition-colors"
        >
          <div
            class="p-4 bg-brand/10 rounded-2xl text-brand group-hover:scale-110 transition-transform"
          >
            <Info size="24" />
          </div>
          <div class="space-y-2">
            ...
            <p class="text-[13px] text-secondary leading-relaxed font-medium">
              Para processamento de baixas automáticas, configure a URL abaixo
              no painel do Asaas:
            </p>
            <div class="flex items-center gap-2 mt-2">
              <code
                class="bg-surface px-4 py-2 rounded-xl font-mono text-xs text-brand border border-border shadow-sm select-all"
              >
      ...
      <div class="xl:col-span-4 space-y-6">
        ...
        <BaseCard
          class="p-8 border-none bg-primary text-background overflow-hidden rounded-[2rem] relative group hover:shadow-2xl transition-all duration-500"
        >
          <div class="relative z-10">
            ...
            >
              Documentação Oficial do Gateway
            </p>
            <a
              href="https://docs.asaas.com"
              target="_blank"
              class="inline-flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.25em] text-brand hover:gap-5 transition-all"
            >
