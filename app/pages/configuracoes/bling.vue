  ...
  <div class="flex flex-col gap-6 animate-enter">
    ...
    >
      <div>
        ...
        >
          Configurações de ERP para emissão de NF-e, NFS-e e Sincronização de
          Estoque
        </p>
      </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
      ...
      <div class="xl:col-span-8 space-y-8">
        ...
        <div class="space-y-4">
          ...
          >
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2 md:col-span-2">
                ...
                <BaseInput
                  ...
                  type="password"
                  :icon="Key"
                  placeholder="Sua Chave API do Bling"
                />
              </div>
            ...
            >
              ...
              <button
                class="px-4 py-2 border border-border rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary/2 transition-all"
              >
                Renovar Token
              </button>
            </div>
        ...
        <div class="space-y-4">
          ...
          <div
            class="bg-surface p-8 rounded-[2rem] border border-border shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6"
          >
            <div class="space-y-2">
              <div class="flex items-center gap-2 ml-2">
                <label
            ...
            <div class="space-y-2 md:col-span-2">
              ...
              <BaseInput
                ...
                :disabled="!isAdmin"
                :icon="Briefcase"
                placeholder="Venda de Mercadorias / Prestação de Serviço"
              />
            </div>

            <div
              class="md:col-span-2 flex items-center justify-between p-4 bg-primary/2 rounded-2xl border border-border/50 group hover:border-[#00AEEF]/30 transition-all"
            >
              <div class="flex items-center gap-4">
                <div
                  class="p-3 bg-white rounded-xl shadow-sm text-[#00AEEF] group-hover:scale-110 transition-transform"
                >
                  <Activity size="20" />
                </div>
                <div>
                  ...
                  >
                    Ativar sincronização automática com o Bling
                  </p>
                </div>
              </div>
              <BaseToggle
      ...
      <div class="xl:col-span-4 space-y-6">
        <div
          class="bg-[#00AEEF] p-8 rounded-[2rem] text-background space-y-6 shadow-2xl shadow-[#00AEEF]/20 relative overflow-hidden group"
        >
          <div
          ...
          <div class="relative z-10 space-y-6">
            ...
            <div class="space-y-4">
              ...
              >
                Ao ativar a integração, todas as vendas aprovadas no sistema
                serão enviadas como "Pedidos de Venda" para o Bling, permitindo
                a emissão rápida de faturas.
              </p>
