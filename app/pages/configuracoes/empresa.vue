  ...
  <div class="flex flex-col gap-6 animate-enter">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
      ...
      <div class="xl:col-span-4 space-y-6">
        ...
        <div
          class="bg-primary p-8 rounded-[2rem] text-background space-y-6 shadow-2xl shadow-primary/20 relative overflow-hidden group"
        >
          <div
            class="absolute -right-10 -top-10 text-background/10 group-hover:scale-110 transition-transform duration-700"
          >
            <Building2 size="250" />
          </div>
          ...
          <div class="relative z-10 space-y-6">
            ...
            <div class="space-y-2">
              ...
              >
                As informações nesta página são utilizadas em documentos
                oficiais, como Orçamentos em PDF e Pedidos de Venda.
              </p>
            </div>
        ...
        <div class="bg-surface p-6 rounded-3xl border border-border space-y-4">
          ...
          <div v-if="user?.empresa" class="space-y-1">
            ...
            <p class="text-[9px] font-bold text-secondary uppercase opacity-50">
              Sincronizado com a base central
            </p>
          </div>
        </div>
      </div>
