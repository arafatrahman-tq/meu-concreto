    ...
    >
      ...
      <div>
        ...
        <p class="text-[10px] font-bold text-amber-500/60 uppercase mt-0.5">
          Somente administradores mestres podem gerenciar a API global de
          WhatsApp.
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
      ...
      <div class="xl:col-span-8 space-y-8">
        ...
        <div class="space-y-4">
          ...
          <div
            class="bg-surface p-10 rounded-3xl border border-border shadow-sm space-y-8"
          >
            <div class="space-y-3">
              <label
              ...
              <BaseInput
                ...
                :disabled="!isAdmin"
                :icon="Globe"
                placeholder="https://api.evolution.com/connections/whatsapp-principal"
              />
            </div>
            ...
            >
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  >
                    Ativar ou desativar todos os envios de WhatsApp
                  </p>
                </div>
              </div>
              <BaseToggle
        ...
        <div class="space-y-4">
          ...
          <div
            class="bg-surface p-10 rounded-3xl border border-border shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6"
          >
            <!-- Contas a Pagar -->
            <div
              class="flex items-center justify-between p-5 bg-primary/2 rounded-xl border border-border/50 group hover:border-brand/30 transition-all"
            >
              <div class="flex items-center gap-4">
                <div
              ...
              <BaseToggle
                v-model="form.notificaContasPagar"
                :disabled="!isAdmin"
                color-class="bg-[#25D366]"
              />
            </div>
            ...
            >
              ...
              <BaseToggle
                v-model="form.notificaCobrancas"
                :disabled="!isAdmin"
                color-class="bg-[#25D366]"
              />
            </div>
            ...
            <!-- Novos Orçamentos -->
            <div
              class="flex items-center justify-between p-5 bg-primary/2 rounded-xl border border-border/50 group hover:border-brand/30 transition-all md:col-span-2"
            >
              <div class="flex items-center gap-4">
                <div
                  class="p-3 bg-white rounded-xl shadow-sm text-brand group-hover:scale-110 transition-transform"
                ...
                <div>
                  <h4
                    class="text-xs font-black uppercase tracking-tight text-primary"
                  >
                    Avisos de Orçamentos
                  </h4>
                  <p
                    class="text-[9px] font-black uppercase tracking-widest text-secondary opacity-40"
                  >
                    Notificar vendedores sobre novas propostas criadas
                  </p>
                </div>
              </div>
              <BaseToggle
                v-model="form.notificaNovosOrcamentos"
                :disabled="!isAdmin"
                color-class="bg-[#25D366]"
              />
            </div>
      ...
      <div class="xl:col-span-4 space-y-6">
        <div
          class="bg-[#25D366] p-8 rounded-[2rem] text-background space-y-6 shadow-2xl shadow-[#25D366]/20 relative overflow-hidden group"
        >
          <div
          ...
          <div class="relative z-10 space-y-6">
            ...
            <div class="space-y-2">
              ...
              >
                Esta instância é utilizada para todos os disparos automáticos do
                sistema (Orçamentos, Vendas e Avisos).
              </p>
            </div>
