  ...
  <div class="flex flex-col gap-6 animate-enter">
    ...
    >
      ...
      <template v-else>
        ...
        >
          <tr
            v-for="item in displayedContas"
            :key="item.id"
            class="group hover:bg-primary/2 transition-colors border-b border-border/50 last:border-0"
          >
            <td class="px-8 py-5">
              <div class="flex flex-col">
                ...
                <span
                  ...
                  class="text-[9px] font-black uppercase opacity-30 mt-0.5 whitespace-nowrap"
                >
        ...
        <div
          v-if="filteredContas.length > itemsToShow"
      ...
      >
        ...
        <div class="flex gap-4 pt-4">
          ...
          <button
            type="submit"
            :disabled="loading"
            class="flex-1 bg-brand text-white px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-brand/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 outline-none"
          >
    ...
    <!-- Pagamento Modal -->
    <BaseModal
      v-model="showPagamentoModal"
      title="Confirmar Pagamento"
      size="sm"
    >
      <div class="p-6 space-y-6">
        <div
          class="bg-primary/3 p-8 rounded-[2rem] border border-border/50 text-center"
        >
          <p
            class="text-[9px] font-black uppercase tracking-widest text-secondary opacity-40 mb-2"
          >
            Total a Pagar
          </p>
          ...
          <p
            class="text-[10px] font-black uppercase tracking-widest text-secondary opacity-60 mt-2"
          >
