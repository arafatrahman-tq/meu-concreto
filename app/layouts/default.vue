    ...
    >
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar pb-10">
          ...
          <div
            v-else-if="search.length >= 2 && searchResults.length === 0"
          ...
          >
            ...
            <p class="text-lg font-black text-primary uppercase tracking-tighter">
              Nenhum resultado para "{{ search }}"
            </p>
            <p class="text-xs text-secondary opacity-40 mt-3 max-w-60 mx-auto leading-relaxed">
              Tente buscar por nomes de clientes, placas de caminhões ou IDs numéricos.
            </p>
          </div>
          ...
          >
            ...
            <p class="text-[10px] font-black uppercase tracking-[0.2em]">
              Digite para iniciar a busca inteligente
            </p>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <nav class="flex-1 px-4 overflow-y-auto no-scrollbar space-y-12 py-2">
        ...
        >
          ...
          <div
            v-else
            class="h-px bg-border/50 mx-4 my-6"
          />
              ...
              <div class="relative export-container">
                ...
                >
                  <div class="p-4 border-b border-border bg-primary/2">
                    <p class="text-[10px] font-black uppercase tracking-widest text-secondary opacity-60">
                  ...
                  <div class="p-2 space-y-1">
                    ...
                    >
                      ...
                      <div>
                        <p class="text-xs font-black uppercase tracking-tight text-primary">
                          Planilha Excel
                        </p>
                        <p class="text-[9px] font-bold text-secondary opacity-40 uppercase">
                          Formato .CSV
                        </p>
                      </div>
                    </button>
